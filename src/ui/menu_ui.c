...
static void lst_1_note_design(gui_obj_t *obj, void *param)
{
    ...
    case 0:
    {
        ...
        img_10 = gui_img_create_from_fs((gui_obj_t *)note, "img_10", "/image/reset_icon.bin", 60, 0, 60, 60);
        // Create img_11 (hg_image)
        img_11 = gui_img_create_from_fs((gui_obj_t *)note, "img_11", "/image/A8/arrow_r_icon.bin", 395, 18, 13, 25);
        gui_img_set_mode((gui_img_t *)img_11, IMG_BYPASS_MODE);
        // Create lbl_6 (hg_label)
        lbl_6 = gui_text_create((gui_obj_t *)note, "lbl_6", 154, 0, 125, 60);
        gui_text_set((gui_text_t *)lbl_6, "Reset", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 5, 28);
        gui_text_type_set((gui_text_t *)lbl_6, "/font/Inter_24pt_SemiBold_size28_bits4_bitmap.bin", FONT_SRC_FILESYS);
    ...
    case 1:
    {
        ...
        img_12 = gui_img_create_from_fs((gui_obj_t *)note, "img_12", "/image/A8/arrow_r_icon.bin", 395, 18, 13, 25);
        gui_img_set_mode((gui_img_t *)img_12, IMG_BYPASS_MODE);
        // Create img_14 (hg_image)
        img_14 = gui_img_create_from_fs((gui_obj_t *)note, "img_14", "/image/erase_icon.bin", 60, 0, 60, 60);
        // Create lbl_7 (hg_label)
        lbl_7 = gui_text_create((gui_obj_t *)note, "lbl_7", 154, 0, 228, 60);
        gui_text_set((gui_text_t *)lbl_7, "Format Storage", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 14, 28);
        gui_text_type_set((gui_text_t *)lbl_7, "/font/Inter_24pt_SemiBold_size28_bits4_bitmap.bin", FONT_SRC_FILESYS);
    ...
    case 2:
    {
        ...
        img_13 = gui_img_create_from_fs((gui_obj_t *)note, "img_13", "/image/A8/arrow_r_icon.bin", 395, 18, 13, 25);
        gui_img_set_mode((gui_img_t *)img_13, IMG_BYPASS_MODE);
        // Create img_15 (hg_image)
        img_15 = gui_img_create_from_fs((gui_obj_t *)note, "img_15", "/image/power_off_icon.bin", 60, 0, 60, 60);
        // Create lbl_8 (hg_label)
        lbl_8 = gui_text_create((gui_obj_t *)note, "lbl_8", 154, 0, 160, 60);
        gui_text_set((gui_text_t *)lbl_8, "Power off", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 9, 28);
        gui_text_type_set((gui_text_t *)lbl_8, "/font/Inter_24pt_SemiBold_size28_bits4_bitmap.bin", FONT_SRC_FILESYS);
...
static void menuMainView_switch_in(gui_view_t *view)
{
    ...
    lst_1 = gui_list_create((gui_obj_t *)view, "lst_1", 1, 117, 465, 250, 60, 28, VERTICAL, lst_1_note_design, NULL, false);
...
static void menuDetailView_switch_in(gui_view_t *view)
{
    ...
    lbl_option = gui_text_create((gui_obj_t *)view, "lbl_option", 0, 195, 466, 76);
    gui_text_set((gui_text_t *)lbl_option, "Reset", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 5, 44);
    gui_text_type_set((gui_text_t *)lbl_option, "/font/Inter_24pt_Regular_size44_bits4_bitmap.bin", FONT_SRC_FILESYS);
    ...
    img_16 = gui_img_create_from_fs((gui_obj_t *)view, "img_16", "/image/A8/rect_bg_red.bin", 292, 294, 113, 58);
    ...
    img_17 = gui_img_create_from_fs((gui_obj_t *)view, "img_17", "/image/A8/rect_bg_grey.bin", 69, 294, 113, 58);
    ...
    lbl_9 = gui_text_create((gui_obj_t *)view, "lbl_9", 79, 299, 94, 48);
    gui_text_set((gui_text_t *)lbl_9, "No", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 2, 28);
    gui_text_type_set((gui_text_t *)lbl_9, "/font/Inter_24pt_Regular_size28_bits4_bitmap.bin", FONT_SRC_FILESYS);
    gui_text_mode_set((gui_text_t *)lbl_9, MID_CENTER);

    // Create lbl_10 (hg_label)
    lbl_10 = gui_text_create((gui_obj_t *)view, "lbl_10", 302, 299, 94, 48);
    gui_text_set((gui_text_t *)lbl_10, "Yes", GUI_FONT_SRC_BMP, gui_rgb(255, 255, 255), 3, 28);
    gui_text_type_set((gui_text_t *)lbl_10, "/font/Inter_24pt_Regular_size28_bits4_bitmap.bin", FONT_SRC_FILESYS);
