...
static void view_cam_ctl_switch_in(gui_view_t *view)
{
    ...
    streaming_1 = gui_stream_create((gui_obj_t *)view, "streaming_1", GUI_STREAM_CODEC_JPEG, gui_stream_transport_get(), 0, 0, 368, 368);
    gui_stream_set_update_interval((gui_stream_t *)streaming_1, 10);
    gui_stream_set_drop_mode((gui_stream_t *)streaming_1, GUI_STREAM_DROP_UNCONDITIONAL);
